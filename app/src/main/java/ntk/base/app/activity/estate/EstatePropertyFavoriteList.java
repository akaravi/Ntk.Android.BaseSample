...
class EstatePropertyFavoriteList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void getData() {
        ...
        RetrofitManager manager = new RetrofitManager(EstatePropertyFavoriteList.this);
        ...
        call.observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new Observer<EstatePropertyFavoriteListResponse>() {
                    ...
                    public void onNext(EstatePropertyFavoriteListResponse response) {
                        JsonDialog cdd = new JsonDialog(EstatePropertyFavoriteList.this, response);
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(EstatePropertyFavoriteList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
