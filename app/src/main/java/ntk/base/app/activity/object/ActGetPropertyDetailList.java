...
public class ActGetPropertyDetailList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_object_get_property_detail_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("ObjectPropertyDetailList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("ObjectPropertyDetailList");
    ...
    private void getData() {
        ObjectPropertyDetailRequest request = new ObjectPropertyDetailRequest();
        ...
        RetrofitManager manager = new RetrofitManager(ActGetPropertyDetailList.this);
        IObject iObject = manager.getRetrofit(configStaticValue.GetApiBaseUrl()).create(IObject.class);
        Map<String, String> headers = new HashMap<>();
        headers = configRestHeader.GetHeaders(this);

        Observable<ObjectPropertyDetailResponse> call = iObject.GetPropertyDetailActList(headers, request);
        call.observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Observer<ObjectPropertyDetailResponse>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                    }

                    @Override
                    public void onNext(ObjectPropertyDetailResponse response) {
                        JsonDialog cdd = new JsonDialog(ActGetPropertyDetailList.this, response);
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(ActGetPropertyDetailList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
