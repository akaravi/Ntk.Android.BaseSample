...
//OK
public class ActGetUserSiteList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_member_get_user_site_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("MemberUserSiteList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("MemberUserSiteList");
    ...
    private void getData() {
        MemberUserSiteRequest request = new MemberUserSiteRequest();
        ...
        RetrofitManager manager = new RetrofitManager(ActGetUserSiteList.this);
        IMember iMember = manager.getRetrofit(configStaticValue.GetApiBaseUrl()).create(IMember.class);
        Map<String, String> headers = new HashMap<>();
        headers = configRestHeader.GetHeaders(this);

        Observable<MemberUserSiteResponse> call = iMember.GetUserSiteActList(headers, request);
        call.observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new Observer<MemberUserSiteResponse>() {
                    ...
                    public void onNext(MemberUserSiteResponse response) {
                        JsonDialog cdd = new JsonDialog(ActGetUserSiteList.this, response);
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(ActGetUserSiteList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
