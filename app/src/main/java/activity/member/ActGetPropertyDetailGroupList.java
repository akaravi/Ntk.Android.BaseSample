...
public class ActGetPropertyDetailGroupList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_member_get_property_detail_group_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("MemberPropertyDetailGroupList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("MemberPropertyDetailGroupList");
    ...
    private void getData() {
        MemberPropertyDetailGroupRequest request = new MemberPropertyDetailGroupRequest();
        ...
        Observable<MemberPropertyDetailGroupResponse> call = iMember.GetPropertyDetailGroupActList(headers, request);
        call.observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Observer<MemberPropertyDetailGroupResponse>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                    }

                    @Override
                    public void onNext(MemberPropertyDetailGroupResponse response) {
                        JsonDialog cdd = new JsonDialog(ActGetPropertyDetailGroupList.this, response);
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(ActGetPropertyDetailGroupList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
