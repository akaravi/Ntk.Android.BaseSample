...
public class ActGetPropertyDetailValueList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_member_get_property_detail_value_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("MemberPropertyDetailValueList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("MemberPropertyDetailValueList");
    ...
    private void getData() {
        MemberPropertyDetailValueRequest request = new MemberPropertyDetailValueRequest();
        ...
        RetrofitManager manager = new RetrofitManager(ActGetPropertyDetailValueList.this);
        IMember iMember = manager.getRetrofit(configStaticValue.GetApiBaseUrl()).create(IMember.class);
        Map<String, String> headers = new HashMap<>();
        headers = configRestHeader.GetHeaders(this);

        Observable<MemberPropertyDetailValueResponse> call = iMember.GetPropertyDetailValueActList(headers, request);
        call.observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Observer<MemberPropertyDetailValueResponse>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                    }

                    @Override
                    public void onNext(MemberPropertyDetailValueResponse response) {
                        JsonDialog cdd = new JsonDialog(ActGetPropertyDetailValueList.this, response);
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(ActGetPropertyDetailValueList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
