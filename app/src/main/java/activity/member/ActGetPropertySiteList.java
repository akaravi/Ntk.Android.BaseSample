...
public class ActGetPropertySiteList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_member_get_property_site_list);
    ...
    private void getData() {
        MemberPropertySiteRequest request = new MemberPropertySiteRequest();
        ...
        Observable<MemberPropertySiteResponse> call = iMember.GetPropertySiteActList(headers, request);
        call.observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Observer<MemberPropertySiteResponse>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                    }

                    @Override
                    public void onNext(MemberPropertySiteResponse response) {
