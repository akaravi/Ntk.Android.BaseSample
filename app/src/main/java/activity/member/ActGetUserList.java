...
public class ActGetUserList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_member_get_user_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("MemberUserList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("MemberUserList");
    ...
    private void getData() {
        MemberUserRequest request = new MemberUserRequest();
        ...
        Observable<MemberUserResponse> call = iMember.GetUserActList(headers, request);
