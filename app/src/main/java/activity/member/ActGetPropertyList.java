...
//ok
public class ActGetPropertyList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_member_get_property_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("MemberPropertyList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("MemberPropertyList");
    ...
    private void getData() {
        MemberPropertyRequest request = new MemberPropertyRequest();
        ...
        RetrofitManager manager = new RetrofitManager(ActGetPropertyList.this);
        IMember iMember = manager.getRetrofit(configStaticValue.GetApiBaseUrl()).create(IMember.class);
        Map<String, String> headers = new HashMap<>();
        headers = configRestHeader.GetHeaders(this);

        Observable<MemberPropertyResponse> call = iMember.GetPropertyActList(headers, request);
        call.observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new Observer<MemberPropertyResponse>() {
                    ...
                    public void onNext(MemberPropertyResponse response) {
                        JsonDialog cdd = new JsonDialog(ActGetPropertyList.this, response);
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(ActGetPropertyList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
