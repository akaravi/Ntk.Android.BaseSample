...
public class ActGetUserSiteList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_object_get_user_site_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("ObjectUserSiteList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("ObjectUserSiteList");
    ...
    private void getData() {
        ObjectUserSiteRequest request = new ObjectUserSiteRequest();
        ...
        Observable<ObjectUserSiteResponse> call = iObject.GetUserSiteActList(headers, request);
