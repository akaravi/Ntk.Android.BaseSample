...
public class ActGetPropertyDetailGroupList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_object_get_property_detail_group_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("ObjectPropertyDetailGroupList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("ObjectPropertyDetailGroupList");
    ...
    private void getData() {
        ObjectPropertyDetailGroupRequest request = new ObjectPropertyDetailGroupRequest();
        ...
        Observable<ObjectPropertyDetailGroupResponse> call = iObject.GetPropertyDetailGroupActList(headers, request);
        call.observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Observer<ObjectPropertyDetailGroupResponse>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                    }

                    @Override
                    public void onNext(ObjectPropertyDetailGroupResponse response) {
