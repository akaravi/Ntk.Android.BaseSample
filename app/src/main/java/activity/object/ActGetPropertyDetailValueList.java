...
public class ActGetPropertyDetailValueList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_object_get_property_detail_value_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("ObjectPropertyDetailValueList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("ObjectPropertyDetailValueList");
    ...
    private void getData() {
        ObjectPropertyDetailValueRequest request = new ObjectPropertyDetailValueRequest();
        ...
        Observable<ObjectPropertyDetailValueResponse> call = iObject.GetPropertyDetailValueActList(headers, request);
        call.observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Observer<ObjectPropertyDetailValueResponse>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                    }

                    @Override
                    public void onNext(ObjectPropertyDetailValueResponse response) {
