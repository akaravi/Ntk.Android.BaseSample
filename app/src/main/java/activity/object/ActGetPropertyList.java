...
public class ActGetPropertyList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_object_get_property_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("ObjectPropertyList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("ObjectPropertyList");
    ...
    private void getData() {
        ObjectPropertyRequest request = new ObjectPropertyRequest();
        ...
        Observable<ObjectPropertyResponse> call = iObject.GetPropertyActList(headers, request);
