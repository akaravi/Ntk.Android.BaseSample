...
public class ActGetHistoryList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_object_get_history_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("ObjectHistoryList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("ObjectHistoryList");
    ...
    private void getData() {
        ObjectHistoryRequest request = new ObjectHistoryRequest();
        ...
        RetrofitManager manager = new RetrofitManager(ActGetHistoryList.this);
        IObject iObject = manager.getRetrofit(configStaticValue.GetApiBaseUrl()).create(IObject.class);
        Map<String, String> headers = new HashMap<>();
        headers = configRestHeader.GetHeaders(this);

        Observable<ObjectHistoryResponse> call = iObject.GetHistoryActList(headers, request);
        call.observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new Observer<ObjectHistoryResponse>() {
                    ...
                    public void onNext(ObjectHistoryResponse response) {
                        JsonDialog cdd = new JsonDialog(ActGetHistoryList.this, response);
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(ActGetHistoryList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
