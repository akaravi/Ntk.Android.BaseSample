...
public class ActGetUserGroupList extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_object_get_user_group_list);
        ButterKnife.bind(this);
        initialize();
    }

    private void initialize() {
        lblLayout.setText("ObjectUserGroupList");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("ObjectUserGroupList");
    ...
    private void getData() {
        ObjectUserGroupRequest request = new ObjectUserGroupRequest();
        ...
        RetrofitManager manager = new RetrofitManager(ActGetUserGroupList.this);
        IObject iObject = manager.getRetrofit(configStaticValue.GetApiBaseUrl()).create(IObject.class);
        Map<String, String> headers = new HashMap<>();
        headers = configRestHeader.GetHeaders(this);

        Observable<ObjectUserGroupResponse> call = iObject.GetUserGroupActList(headers, request);
        call.observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Observer<ObjectUserGroupResponse>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                    }

                    @Override
                    public void onNext(ObjectUserGroupResponse response) {
                        JsonDialog cdd = new JsonDialog(ActGetUserGroupList.this, response);
                    ...
                    public void onError(Throwable e) {
                        ...
                        Toast.makeText(ActGetUserGroupList.this, "Error : " + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
